...
####### Compile flags #######
EXE_CFLAGS = -Wall -Wextra -std=c++14 -ggdb -Iinclude -Iinclude/SFML
DLL_CFLAGS = $(EXE_CFLAGS) -fPIC

####### Linker flags #######
#Linker flags for static exe build
EXE_LFLAGS = -Wall -Wextra -std=c++14 -ggdb -Llib/SFML -lsfml-graphics -lsfml-audio -lsfml-window -lsfml-system -lopengl32
